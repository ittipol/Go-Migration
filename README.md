# Go programming language - Migration
...
``` go
// Insert Record With Selected Fields
...
// Get top 50 record ordered by quantity
db.Order("quantity DESC").Limit(50).Find(&products)
```
...
### Not Conditions
- https://gorm.io/docs/query.html#Not-Conditions
